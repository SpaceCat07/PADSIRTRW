<form action="{{route('RW.Keuangan.update', $laporan -> id)}}" method="post">
    @csrf
    @method('PATCH')
    ...
    <div>
        <label for="path_file">Laporan Keuangan RW:</label>
        @if($laporan->path_file)
            ...
            <a href="{{route('RW.Keuangan.show', $laporan -> id)}}">Download Laporan</a>
        @else
    ...
    <button type="submit">Ubah Data Laporan Keuangan RW</button>
</form>
