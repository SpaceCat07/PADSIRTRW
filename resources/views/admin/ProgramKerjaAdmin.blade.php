        ...
        function fetchPrograms() {
            ...
            .then(response => {
                if (response.data && Array.isArray(response.data.data)) {
                    programs = response.data.data.map(program => {
                        ...
                        return {
                            ...
                            status: program.status ? program.status.toLowerCase() : 'upcoming' // Default status
                        };
                    });
                    ...
                    applyFilter('all');
                    renderCalendar(); // Render kalender setelah data program ada
                    loadNotifications(programs);
                } else {
                    programList.innerHTML = '<div>Format data program kerja tidak sesuai.</div>';
                }
            })
            .catch(error => {
