...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const form = document.getElementById('addIncomeForm'); // Ganti ke 'addIncomeForm' jika di halaman pemasukan
    ...
    if (form) {
        form.addEventListener('submit', async (event) => {
            ...
            // Sesuaikan 'variance' berdasarkan halaman
            formData.append('variance', 'inflow');
