...
@section('content')
    ...
    <div class="laporan-container">
        ...
        <div class="report-action-buttons">
            ...
            <a href="{{ route('tambah-data-pemasukan') }}"><button class="action-btn btn-add-data">+ Tambah
                    Data</button></a>
        </div>
        <div class="sort-by">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            async function fetchData() {
                ...
                try {
                    ...
                    // Logika untuk Saldo Akhir (tetap sama, mengambil dari semua transaksi)
                    ...
                    // [DIUBAH] Saring data untuk menampilkan HANYA pemasukan di tabel
